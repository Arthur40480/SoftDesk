...
urlpatterns = [
    ...
    path('api/projects/<int:project_pk>/issue/<int:issue_pk>/comment/', CommentCreateAndList.as_view(), name='create_list_comment'),
    path('api/projects/<int:project_pk>/issue/<int:issue_pk>/comment/<int:comment_pk>/', CommentDetail.as_view(), name='create_list_comment')
]